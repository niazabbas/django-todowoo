    ...
    if request.method == "GET":
        ...
        if request.POST["password1"] == request.POST["password2"]:
            try:
                ...
                return render(request, 'todo/signupuser.html', {'form':UserCreationForm(), 'error':'That password has already been taken. Please choose a new username!'})
                #return HttpResponse('username: ' + request.POST["username"] + "<br>Password: " + request.POST["password1"])
        else:
